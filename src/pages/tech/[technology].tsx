...
const technologyData = {
  'android-developer': {
    ...
    services: {
      ...
      subTitle: 'Hire offshore Android app programmers to create feature-rich applications.',
      services: [
        {
  ...
  'ios-developer': {
    ...
    services: {
      mainTitle: 'Hire expert iOS developers to build robust, high-performance apps.',
      // highlightedWord: "App Developers",
      subTitle:
  ...
  'flutter-developer': {
    ...
    services: {
      mainTitle: 'Hire Expert Flutter Developers to Build High-Performance Apps',
      // highlightedWord: "App Developers",
      subTitle:
  ...
  'react-js-developer': {
    ...
    services: {
      mainTitle: 'Hire Expert ReactJS Developers for Your Upcoming Web Project!',
      // highlightedWord: "App Developers",
      subTitle:
  ...
  'node-js-developer': {
    ...
    services: {
      mainTitle: 'Hire Expert Node.js Developers to Build Scalable, High-Performance Applications.',
      // highlightedWord: "App Developers",
      subTitle:
  ...
  'python-developer': {
    ...
    services: {
      mainTitle: 'Hire Expert Python Developers to Build Scalable, High-Performance Applications.',
      // highlightedWord: "App Developers",
      subTitle:
    ...
    carousel: {
      ...
      cardsData: [
        ...
        },
        {
          ...
          description:
            'Boost sales and visibility on platforms like Shopify, WooCommerce, and Amazon with structured SEO strategies.',
          icon1: '/seo.png',
        },
        {
          id: 8,
  ...
  shopify: {
    ...
    description:
      ' Looking for a skilled Shopify developer from India? Your search ends here! Hire top Shopify developers from Brandsmashers Tech to build secure, scalable, and high-performing eCommerce stores. Our experts ensure seamless integrations, user-friendly designs, and customized solutions tailored to meet your business needs. Hire Shopify developers today to create a feature-rich online store that drives conversions and growth.',
