  ...
  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-[#ff5010]/20 backdrop-blur-sm rounded-full border border-[#ff5010]/30 mb-4 overflow-hidden">
    ...
    />
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-[#ff5010]/20 backdrop-blur-sm rounded-full border border-[#ff5010]/30 mb-6 sm:mb-8 animate-bounce">
            ...
            <span className="text-xs sm:text-sm font-medium">Connect With Innovation</span>
          </div>
      ...
      {/* Team Section */}
      <section id="team" className="relative px-2 py-4 bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <p className="text-base sm:text-xl text-gray-300 max-w-2xl mx-auto">
              Passionate professionals dedicated to pushing boundaries and creating exceptional experiences
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="relative p-4 sm:p-6">
                  <h3 className="text-xl sm:text-2xl font-bold mb-0.5 sm:mb-1">{member.name}</h3>
                  <p className="text-[#ff5010] font-semibold mb-3 sm:mb-4 text-sm sm:text-base">{member.role}</p>
                  <p className="text-gray-300 text-sm leading-relaxed mb-4 sm:mb-6">{member.bio}</p>
      ...
      <footer className="relative px-2 py-4 border-t border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center text-gray-400 text-xs sm:text-sm">
            <p>© 2024 Brandsmashers Tech. All rights reserved. | Crafted with passion and innovation.</p>
          </div>
        </div>
      </footer>
      </div>
