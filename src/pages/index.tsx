...
export default function Home() {
  return (
    <div className="bg-[#343333]">
      <SEO
        title="Brandsmashers Tech | Custom Software & IT Solutions"
        description="Brandsmashers Tech delivers innovative custom software development, IT outsourcing, and scalable web & mobile app solutions for startups and enterprises."
        ogImage="/logo.jpg"
      />
      <Navbar />
      <HeroSection />
