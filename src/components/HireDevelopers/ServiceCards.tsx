...
import { Brain, Target, Workflow, Zap } from 'lucide-react';
import type { ServiceItem, ServiceCardProps } from '@/types/service';
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Icon rendering (if iconSrc is present, render image; else, render icon component) */}
                  {service.iconSrc ? (
                    <img src={service.iconSrc} alt={service.title} className="w-8 h-8 mt-2" />
                  ) : service.icon ? (
                    React.createElement(service.icon, { className: 'w-8 h-8 mt-2 text-[#ff5010]' })
                  ) : null}
                </div>
