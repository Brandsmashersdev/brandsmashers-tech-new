...
const HeroSectionTech = ({ title, description, buttonText }) => {
  const defaultDescription =
    "Transform your business with cutting-edge technology solutions designed to drive growth, efficiency, and innovation in today's digital landscape.";
    ...
    <div className="hero-wrapper">
      ...
      <div className="hero-container">
        <div className="content-section">
          {title && <div className="badge">{title}</div>}

          <h1 className="hero-title">
            Innovative solutions <span className="highlight">for your business</span>
          </h1>

          <p className="hero-description">{description || defaultDescription}</p>
