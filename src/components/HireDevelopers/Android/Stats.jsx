      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Delivering Excellence at{" "}
            <span className="text-[#ff5722]">BrandSmashers technology</span>
          </h2>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            At Brandsmashers Tech, we have a team of skilled, vetted, and
            dedicated software developers who deliver client-focused custom
            software development services tailored to your unique business
            needs.
          </p>
        </div>
