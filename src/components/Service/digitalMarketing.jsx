        ...
        <div className={styles.leftSection}>
          <div className={styles.titleGroup}>
            <h1 className={styles.title}>
              <span className={styles.highlight}>Digital Marketing</span>
            </h1>
          ...
          <div className={styles.textContent}>
            <p>
              ...
              provides you with complete solutions through effective Search
              ...
              not only the growth of your business but also the differentiation
              of the same in a competitive environment. Try Brandsmashers to
              boost your internet marketing approach and get spectacular change
              for your brand!
            </p>
          </div>
        </div>
          ...
          <div className={styles.imageWrapper}>
            ...
            <div className={styles.overlayBox}>
              <p>
                ...
                the Best Digital Marketing Agency in Bhopal, offers tailored
                strategies through SEO, Social Media Management, and Content
                Marketing. We optimize results by evolving strategies, ensuring
                business growth and differentiation in a competitive market.
              </p>
            </div>
          </div>
        </div>
