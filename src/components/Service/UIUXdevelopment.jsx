  ...
  <div className="max-w-6xl mx-auto">
    <div className="text-center mb-12">
      ...
      <p className="text-left max-w-3xl mx-auto text-lg text-gray-800 font-medium">
        Leverage the expertise of a top app development company to build
        high-performance, feature-rich mobile apps.
      </p>
    </div>
    ...
    <div className="flex flex-wrap justify-center gap-8">
      {[
        ...
        <div
          key={index}
          className="px-6 py-3 bg-white dark:bg-white rounded-full shadow-md font-medium"
