          ...
          <div className={styles.imageWrapper}>
            ...
            <div className={styles.overlayBox}>
              <p>
                ...
                Development Services transform raw data into actionable insights.
                From data collection to advanced analytics, we deliver tailored solutions
                like predictive analytics and BI dashboards to empower informed decisions and drive growth.
              </p>
            </div>
          </div>
        </div>
