  ...
  const industries = [
    {
      ...
      description:
        'Innovative property management, virtual tours, and smart building applications.',
      icon: 'home',
    },
    {
      title: 'Retail Solutions',
      description:
        'End-to-end e-commerce platforms, inventory management, and customer loyalty systems.',
      icon: 'shopping-bag',
    },
    {
    ...
    },
    {
      ...
      description:
        'Charging infrastructure software, battery management, and fleet monitoring systems.',
      icon: 'bolt',
    },
    {
      title: 'Cloud Solutions',
      description:
        'Scalable cloud infrastructure, migration services, and managed cloud solutions.',
      icon: 'cloud',
    },
    {
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:space-y-0">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 mb-8">
              ...
              tailor-made technology solutions. From startups to enterprises, we deliver
              cutting-edge software, web, mobile, and AI-driven services that drive growth,
              efficiency, and digital transformation.
            </p>
            <p className="text-gray-300 mb-8">
              Our IT staff augmentation services help you scale your team effortlessly with
              top-tier, on-bench talent ready to jump into your projects and accelerate delivery.
            </p>
          </div>
          ...
          <div className="w-full md:w-96 bg-gray-900 rounded-lg border border-gray-800 p-6 mt-8 md:mt-0">
            <div className="flex justify-center mb-4">
              <div
                className="bg-ff5010 rounded-full p-3"
                style={{ backgroundColor: 'rgba(255, 80, 16, 0.2)' }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
