      ...
      <main className="max-w-3xl mx-auto px-4 py-10 font-sans text-gray-800">
        ...
        <section className="space-y-6 text-[17px] leading-8">
          ...
          <p>
            ...
            engineering colleges, the job market hasn’t kept up with the talent being developed.
          ...
          <p>
            ...
            involved late nights, tight deadlines, and minimal resources—but also deep partnerships
            and trust.
          </p>
          ...
          <p>
            ...
            people is now a team of 70+. It hasn’t been easy—we’ve invested time, energy, and
            personal funds—but our perseverance fueled each new chapter.
          </p>
          ...
          <p>
            ...
            out.” We began our journey with the MERN stack, React Native, and WordPress—empowering
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong>Front-End Development:</strong> React.js, Angular, Vue.js, Next.js – For
              responsive UIs.
            </li>
            <li>
              <strong>Back-End Development:</strong> Node.js, Python, Laravel, Java – For scalable
              server-side systems.
            </li>
            <li>
              <strong>Mobile Development:</strong> Flutter, React Native, Swift, Kotlin – For
          ...
          <h2 className="text-2xl font-bold mt-10">Sky's the Limit — This is Just the Beginning</h2>
          <p>
          ...
          <p>
            <strong>"Evolution with Struggle"</strong> – the mantra of our founder Aayush Jain. Our
            journey reflects resilience, learning, and relentless pursuit of growth.
          </p>

          <p>
            <strong>"Youth and Energy"</strong> – the philosophy of co-founder Muskan Chhatrasal. She
