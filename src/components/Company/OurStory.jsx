...
export default function FounderCard() {
  ...
  {/* Facebook */}
  <button
    onClick={() => window.open("https://www.facebook.com/brandsamsherstechnologies/", "_blank")}
    className="p-2 rounded-full bg-[#ff5010] text-white hover:bg-[#e04509] transition-colors"
  >
  ...
  {/* LinkedIn */}
  <button
    onClick={() => window.open("https://www.linkedin.com/company/brandsmashers-tech/posts/?feedView=all", "_blank")}
    className="p-2 rounded-full bg-[#ff5010] text-white hover:bg-[#e04509] transition-colors"
  >
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {/* Instagram */}
  <button
    onClick={() => window.open("https://www.instagram.com/brandsmashers_technologies/", "_blank")}
    className="p-2 rounded-full bg-[#ff5010] text-white hover:bg-[#e04509] transition-colors"
  >
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
