...
// src/components/Company/MilestoneTimeline.jsx
import Image from 'next/image';
import AchievementIcon from '/public/Nav-Dropdown-icons/Achievement.png'; // ✅ Import static image
            ...
            <div className="space-y-16">
              {milestones.map((milestone) => (
                <div key={milestone.id} className="relative">
                  {/* Icon */}
                  <div className="absolute left-0 top-1">
                    <div className="relative w-12 h-12 rounded-full border-2 border-[#ff5010] overflow-hidden bg-gray-800 flex items-center justify-center">
                      <Image
                        src={milestone.icon}
                        alt={milestone.title}
                        width={24}
                  ...
                  {/* Text Content */}
                  <div className="pl-20">
                    <h3 className="text-xl lg:text-2xl font-semibold mb-4 text-left leading-relaxed">
                      {milestone.title}
                    </h3>
                    <p className="text-gray-300 text-left leading-relaxed text-base lg:text-lg">
