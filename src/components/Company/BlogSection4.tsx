      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="prose prose-sm sm:prose-lg max-w-none">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6 first-letter:text-4xl sm:first-letter:text-6xl first-letter:font-bold first-letter:text-orange-500 first-letter:float-left first-letter:mr-2 sm:first-letter:mr-3 first-letter:mt-1">
              ...
              establishment of Brandsmashers Tech. During the uncertainty of the COVID-19 pandemic,
              as the world came to a halt, a bold vision was born. While businesses closed and
              routines shifted overnight, the founders saw not just disruption but opportunity.
            </p>
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              Bhopal, a city of lakes, holds great potential for growth. While it boasts several
              engineering colleges, the job market hasn&apos;t kept up with the talent being
              developed. Brandsmashers Tech aimed to bridge this gap by creating employment
              opportunities locally, reducing the need for migration.
            </p>
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
              Why were we named Brandsmashers? It started as a marketing and branding initiative,
              not staff augmentation. Our evolution into a leading software development company
              reflects our adaptability and grit. From a handful of employees to a thriving team,
              the journey involved late nights, tight deadlines, and minimal resources—but also deep
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              ...
              people is now a team of 70+. It hasn&apos;t been easy—we&apos;ve invested time,
              energy, and personal funds—but our perseverance fueled each new chapter.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            <div className="bg-black rounded-lg sm:rounded-xl p-4 sm:p-6 text-white hover:transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-300 text-xs sm:text-sm">
                Artificial Intelligence / Web3 / Storytelling
              </p>
            </div>
            ...
            <div className="bg-black rounded-lg sm:rounded-xl p-4 sm:p-6 text-white hover:transform hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-300 text-xs sm:text-sm">
                Staff Augmentation / Remote Tech Hiring
              </p>
            </div>
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="border-l-4 border-orange-500 pl-4 sm:pl-6 py-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4 sm:p-6 mb-4 sm:mb-6">
                <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4">
                  When speed, scalability, and a JavaScript-centric approach are paramount, MERN
                  stands out. We began our journey with the MERN stack, React Native, and
                  WordPress—empowering us to deliver versatile digital solutions.
                </p>
              </div>
            </div>
            ...
            <div className="border-l-4 border-orange-500 pl-4 sm:pl-6 py-4">
              <h3 className="text-xl sm:text-2xl font-bold text-black mb-4">
                Today, Our Expertise Spans Across
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    React.js, Angular, Vue.js, Next.js – For responsive UIs
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Node.js, Python, Laravel, Java – For scalable server-side systems
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Flutter, React Native, Swift, Kotlin – For cross-platform and native apps
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Seamless handling of both frontend and backend
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Using data-driven insights for intelligent solutions
                  </p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-lg transition-shadow">
                  <h4 className="font-semibold text-black mb-2 text-sm sm:text-base">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm">
                    Still expanding our capabilities in this area
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-12 sm:mb-16">
          <div className="flex items-center mb-6 sm:mb-8">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black">
              Sky&apos;s the Limit — This is Just the Beginning
            </h2>
          </div>

          <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8">
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6">
              Our ambition is to become a trusted engineering partner for global enterprises,
              solving complex problems through innovation and collaboration. We aim to drive digital
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-black text-white rounded-lg sm:rounded-xl p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-orange-400">
                Evolution with Struggle
              </h3>
              <p className="text-gray-300 text-sm sm:text-base">
                The mantra of our founder Aayush Jain. Our journey reflects resilience, learning,
            ...
            <div className="bg-black text-white rounded-lg sm:rounded-xl p-4 sm:p-6">
              ...
              <p className="text-gray-300 text-sm sm:text-base">
                The philosophy of co-founder Muskan Chhatrasal. She believes in the power of young
                changemakers with bold ideas and a hunger for innovation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <div className="max-w-3xl mx-auto bg-black text-white rounded-xl sm:rounded-2xl p-8 sm:p-12">
            ...
            <div className="space-y-4 sm:space-y-6 text-base sm:text-lg text-gray-300 leading-relaxed">
              <p>
                Our journey from a small branding initiative to a thriving tech company of 70+
                professionals showcases the power of vision, perseverance, and adaptability.
              </p>
              <p>
                Through strategic partnerships with industry leaders and continuous evolution of our
                technical capabilities, we&apos;ve proven that great opportunities emerge from the
                greatest challenges.
              </p>
