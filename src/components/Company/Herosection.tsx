    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
        ...
        <div className="md:w-1/2 space-y-6 text-sm sm:text-base md:text-lg lg:text-xl text-gray-300">
          <div>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white mb-10 max-w-4xl mx-auto leading-relaxed text-justify">
              At <span className="font-semibold text-[#ff5010]">Brandsmashers Tech</span>, we
              don&apos;t just build technology — we build futures. We&apos;re a dynamic team of
              creators, coders, marketers, and dreamers who thrive on innovation and collaboration.
              If you&apos;re looking to grow, challenge yourself, and make an impact, your journey
              starts here.
            </p>
          </div>
        </div>
