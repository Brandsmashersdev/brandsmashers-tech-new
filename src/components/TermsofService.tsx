          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-300 mb-4">
                Welcome to {companyDetails.name}. These Terms of Service govern your use of our
                website, products, and services. By accessing or using our services, you agree to be
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">The personal information we collect may include:</p>
              <ul className="list-disc list-inside text-gray-300 mb-6 ml-4">
                ...
                <li className="mb-2">
                  &quot;Services&quot; refers to all products, software, solutions, and services
                  offered by {companyDetails.name}.
                </li>
                <li className="mb-2">
                ...
                <li className="mb-2">
                  &quot;Website&quot; refers to {companyDetails.website} and all subdomains.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                Our services are designed to empower businesses across all industries with
                innovative, tailor-made technology solutions. You agree to use our services only for
                lawful purposes and in accordance with these Terms. You are prohibited from using
                our services in any way that could damage, disable, or impair our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                ...
                compilations, and software, are the exclusive property of {companyDetails.name} and
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                To the maximum extent permitted by law, {companyDetails.name} shall not be liable
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                ...
                any material changes by posting the updated Terms on this page with a new effective
                date. Your continued use of our services after such modifications will constitute
