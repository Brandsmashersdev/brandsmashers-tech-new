          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-300 mb-4">
                At Brandsmashers Tech, we respect your privacy and are committed to protecting your
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                Brandsmashers Tech may collect and use your personal information for the following
                purposes:
              </p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                We implement appropriate data collection, storage, processing practices, and
              ...
              <p className="text-gray-300">
                ...
                of electronic storage is 100% secure, and we cannot guarantee the absolute security
                of your data.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300">
                ...
                site or administer activities on our behalf, such as sending out newsletters or
                surveys. We may share your information with these third parties for those limited
                purposes if you have given us your permission.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                ...
                user&apos;s web browser places cookies on their hard drive for record-keeping
                purposes and sometimes to track information about them. Users may choose to set
                their web browser to refuse cookies or to alert you when cookies are being sent.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-300 mb-4">
                Brandsmashers Tech has the discretion to update this privacy policy at any time.
                When we do, we will revise the updated date at the top of this page. We encourage
                users to frequently check this page for any changes to stay informed about how we
                are helping to protect the personal information we collect.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
                <p className="text-gray-300 mb-2">
                  <strong>Brandsmashers Tech</strong>
                </p>
