      ...
      <div className={styles.content}>
        <header className={styles.heading}>
          ...
          <p className={styles.subheading}>
            At <span className={styles.highlight}>Brandsmashers</span>, we do not just build
            software; we build long-term partnerships based on trust, quality, and innovation. Our
            commitment to excellence ensures that we consistently deliver top-tier solutions that
