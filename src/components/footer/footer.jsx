  ...
  return (
    <footer className="relative bg-gradient-to-b from-black to-black text-white">
      ...
      <div className="absolute top-0 left-0 right-0 h-12 overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-0 left-0 right-0 h-12 bg-[#ff5010]"
          style={{ clipPath: 'polygon(0 0, 100% 0, 100% 80%, 0 0)', opacity: 0.15 }}
        ></div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-gray-400 pr-4 mt-6 leading-relaxed">
              We are a leading Software Development Company delivering excellence and innovation
              since 2010. Our expertise spans across various technologies and industries.
            </p>
            <div className="flex flex-col space-y-3 text-gray-300 pt-2">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center text-[#ff5010]">
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 pb-2 border-b border-gray-800 flex items-center">
              <span className="inline-block mr-2 w-2 h-6 bg-[#ff5010]"></span>Services
            </h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 pb-2 border-b border-gray-800 flex items-center">
              <span className="inline-block mr-2 w-2 h-6 bg-[#ff5010]"></span>Company
            </h3>
            <ul className="space-y-3 text-gray-400">
              {[
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 pb-2 border-b border-gray-800 flex items-center">
              <span className="inline-block mr-2 w-2 h-6 bg-[#ff5010]"></span>Industries
            </h3>
            <ul className="space-y-3 text-gray-400">
              {[
                { name: 'Blog', link: '/Blog' },
                { name: 'Technology', link: '/technologies' },
            ...
            {[
              {
                ...
                link: 'https://www.facebook.com/brandsamsherstechnologies',
              },
              {
                icon: <FaInstagram size={16} />,
                link: 'https://www.instagram.com/brandsmashers_technologies/?hl=en',
              },
              {
                icon: <FaLinkedinIn size={16} />,
                link: 'https://in.linkedin.com/company/brandsmashers-tech-pvt-ltd',
              },
              {
                icon: <FaYoutube size={16} />,
                link: 'https://www.youtube.com/@Brandsmashers',
              },
            ].map(({ icon, link }, idx) => (
              <a
                key={idx}
