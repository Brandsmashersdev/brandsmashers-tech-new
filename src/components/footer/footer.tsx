      ...
      <div className="container mx-auto px-6 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-gray-400 pr-4 mt-6 leading-relaxed">
              Brandsmashers Tech is a trusted software development and IT staff augmentation
              company, helping startups and enterprises build custom digital solutions and hire top
              remote developers from India since 2018.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0">
            © {currentYear} BrandsmashersTech. All rights reserved.
          </div>
