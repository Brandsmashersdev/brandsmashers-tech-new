  ...
  const steps = [
    {
      ...
      description:
        'Tell us your exact project requirements and our team will review and find the best developer for you.',
    },
    {
      ...
      description:
        'Our technical team evaluates the requirements or job description and shares the top-qualified resumes with you for assessment.',
    },
    {
      title: 'Interview',
      icon: (
      ...
      description:
        'We set up meetings with shortlisted candidates so you can evaluate and decide with confidence.',
    },
    {
      ...
      description:
        'After finalizing candidates, provide us with the necessary company details to complete the NDA and onboarding process.',
    },
    {
      ...
      description:
        'After all the formalities are completed, you can assign tasks to the developer and start the project development.',
    },
  ];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black mb-6">
            Hire Pre-vetted Developers from{' '}
            <span className="text-orange-500">Best IT Staff Augmentation Company</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Tired of slow hiring and mismatched talent? With Brandsmashers Tech, you can hire
            pre-vetted developers from the best IT Staff Augmentation company, without the delays or
            guesswork. We streamline the entire process—from understanding your project needs to
            onboarding top-tier developers—so you can build faster, smarter, and with full
            confidence.
          </p>
        </div>
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`relative z-10 flex flex-col bg-white p-6 rounded-2xl transition-all duration-300 h-full
                  ${
                    activeStep === index
                      ? 'shadow-xl border-t-4 border-orange-500 transform -translate-y-2'
                      : 'shadow border-t-4 border-transparent hover:shadow-lg'
                  }
                `}
                >
                  <div className="mb-6">
                    <div
                      ...
                      ${
                        activeStep === index
                          ? 'bg-orange-500'
                          : 'bg-gray-200 text-gray-600 group-hover:bg-orange-400 group-hover:text-white'
                      }
                    `}
                    >
                      {step.icon}
