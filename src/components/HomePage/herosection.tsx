...
const phrases = ['Modern Trendy', 'Unique Design', 'Fully Responsive', 'Developer Friendly'];
    ...
    const createInfinitePartners = () => {
      ...
      for (let i = 0; i < repeatCount; i++) {
        partners.forEach((partner) => {
          ...
          div.className =
            'partner-logo flex-shrink-0 transition-transform hover:scale-110 duration-300';
          ...
          img.alt = partner.alt;
          img.className =
            'h-6 sm:h-8 md:h-10 w-auto object-contain transition-all duration-300 filter brightness-0 invert opacity-80 hover:opacity-100';
      ...
      <section className="relative">
        ...
        <div className="w-full min-h-screen bg-cover bg-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-10">
            ...
            <div
              className="absolute bottom-1/3 right-1/4 w-32 sm:w-48 md:w-80 nest-hub:w-40 nest-hub-max:w-48 h-32 sm:h-48 md:h-80 nest-hub:h-40 nest-hub-max:h-48 rounded-full bg-gradient-to-l from-[#ff5010]/15 to-transparent blur-3xl animate-pulse"
          ...
          <div
            className="relative z-20 container mx-auto px-4 sm:px-6 nest-hub:px-8 nest-hub-max:px-12 flex flex-col justify-center items-center md:items-start h-full min-h-screen nest-hub:min-h-[600px] nest-hub-max:min-h-[800px] "
          ...
          >
            <div className="pt-20 sm:pt-24 md:pt-0 nest-hub:pt-4 nest-hub-max:pt-8 md:max-w-3xl nest-hub:max-w-4xl nest-hub-max:max-w-5xl text-center md:text-left nest-hub:text-center nest-hub-max:text-center">
              ...
              <div className="inline-flex items-center px-2 sm:px-3 nest-hub:px-4 nest-hub-max:px-5 py-1 nest-hub:py-1.5 nest-hub-max:py-2 rounded-full bg-gray-800/80 backdrop-blur-sm border border-gray-700 mb-4 sm:mb-6 nest-hub:mb-3 nest-hub-max:mb-4 overflow-hidden relative">
                ...
                <Star
                  size={12}
                  className="text-[#ff5010] mr-1 sm:mr-2 nest-hub:mr-2 nest-hub-max:mr-3"
                />
              ...
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-5xl nest-hub:text-3xl nest-hub-max:text-4xl font-bold leading-tight mb-4 sm:mb-6 nest-hub:mb-3 nest-hub-max:mb-4 ">
                <span className="text-[#ff5010]">Hire Skilled Remote Developers</span>
              ...
              <div className="mb-4 sm:mb-6 nest-hub:mb-3 nest-hub-max:mb-4">
                ...
                <p className="text-xs sm:text-sm md:text-base nest-hub:text-sm nest-hub-max:text-base text-gray-300 max-w-lg nest-hub:max-w-2xl nest-hub-max:max-w-3xl mx-auto md:mx-0 nest-hub:mx-auto nest-hub-max:mx-auto">
                  Access top-tier tech talent at competitive rates. Hire pre-vetted remote
                  developers from India to scale your team quickly, efficiently, and
                  cost-effectively.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 nest-hub:gap-8 nest-hub-max:gap-10 max-w-xs sm:max-w-sm nest-hub:max-w-md nest-hub-max:max-w-lg mx-auto md:mx-0 nest-hub:mx-auto nest-hub-max:mx-auto">
                <div className="text-center">
                  <div className="text-[#ff5010] font-bold text-xl sm:text-2xl md:text-3xl nest-hub:text-2xl nest-hub-max:text-3xl">
                    7+
                  </div>
                  <div className="text-gray-400 text-xs nest-hub:text-sm nest-hub-max:text-base">
                    Years
                  </div>
                </div>
                <div className="text-center">
          ...
          <div className="absolute bottom-0 left-0 right-0 py-4 sm:py-6 nest-hub:py-3 nest-hub-max:py-4 overflow-hidden z-20">
            ...
            >
              <div className="text-center mb-2 sm:hidden nest-hub:hidden nest-hub-max:hidden"></div>
        ...
        <style jsx global>{`
          ...
          @media (width: 1024px) and (height: 600px) and (orientation: landscape) {
            ...
            .nest-hub\:space-y-0 > :not([hidden]) ~ :not([hidden]) {
              --tw-space-y-reverse: 0;
              margin-top: calc(0px * calc(1 - var(--tw-space-y-reverse)));
              margin-bottom: calc(0px * var(--tw-space-y-reverse));
            }
            .nest-hub\:space-x-4 > :not([hidden]) ~ :not([hidden]) {
          ...
          @media (width: 1280px) and (height: 800px) and (orientation: landscape) {
            ...
            .nest-hub-max\:text-base {
              font-size: 1rem;
              line-height: 1.5rem;
            }
            .nest-hub-max\:text-4xl {
              font-size: 2.25rem;
              line-height: 2.5rem;
            }
            .nest-hub-max\:text-xl {
              font-size: 1.25rem;
              line-height: 1.75rem;
            }
            .nest-hub-max\:max-w-3xl {
              max-width: 48rem;
            }
            .nest-hub-max\:mx-auto {
              margin-left: auto;
              margin-right: auto;
            }
            .nest-hub-max\:flex-row {
              flex-direction: row;
            }
            .nest-hub-max\:space-y-0 > :not([hidden]) ~ :not([hidden]) {
              --tw-space-y-reverse: 0;
              margin-top: calc(0px * calc(1 - var(--tw-space-y-reverse)));
              margin-bottom: calc(0px * var(--tw-space-y-reverse));
            }
            .nest-hub-max\:space-x-6 > :not([hidden]) ~ :not([hidden]) {
              --tw-space-x-reverse: 0;
            ...
            .nest-hub-max\:max-w-lg {
              max-width: 32rem;
            }
            .nest-hub-max\:text-3xl {
              font-size: 1.875rem;
              line-height: 2.25rem;
            }
            .nest-hub-max\:text-center {
              text-align: center;
            }
            .nest-hub-max\:w-56 {
              width: 14rem;
            ...
            .nest-hub-max\:min-h-\[800px\] {
              min-height: 800px;
              margin-left: 10rem;
            }
            .nest-hub-max\:max-w-5xl {
              max-width: 64rem;
            }
            .nest-hub-max\:py-4 {
              padding-top: 1rem;
