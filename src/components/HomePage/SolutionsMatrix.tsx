...
// ✅ Moved outside the component to avoid useEffect dependencies warning
const targetCounts = {
  experts: 1000,
  projects: 2000,
  customers: 300,
    ...
    <div className="bg-white py-16 px-4 md:px-8 font-sans">
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto mb-16 gap-12 items-center">
        ...
        <div className="md:w-1/2 space-y-6">
          <div className="relative">
            <h2 className="text-4xl font-bold mb-2 relative z-10" style={{ color: mainColor }}>
              Solutions Matrix
            </h2>
            <div className="absolute bottom-0 left-0 w-24 h-3 rounded-full opacity-40" style={{ backgroundColor: mainColor }} />
          </div>

          <h3 className="text-3xl font-bold text-gray-800">
            Proof is in the <span className="italic" style={{ color: mainColor }}>Numbers</span>
          </h3>
            ...
            {[
              ...
              >
                <div className="flex justify-center mb-4">
                  <Icon size={48} className="opacity-90" style={{ color: mainColor }} />
                </div>
                <h2 className="text-4xl md:text-5xl font-bold mb-2" style={{ color: mainColor }}>
                  {count}
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold mb-2" style={{ color: mainColor }}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {technologies.map((tech, index) => (
            <div key={index} className="px-6 py-3 rounded-lg bg-gray-50 shadow-sm hover:shadow transition-all duration-300">
