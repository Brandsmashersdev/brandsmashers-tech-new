...
//           <p className="text-left max-w-3xl mx-auto text-lg text-gray-700">
    ...
    <div className="relative py-20 bg-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl">
            ...
            > 
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100 relative mx-4 min-h-[320px]">
                    {/* Orange accent corner */}
                    <div className="absolute top-0 right-0 w-16 h-16 bg-[#ff5010] opacity-10 rounded-bl-3xl"></div>
                    ...
                    {/* Testimonial content */}
                    <p className="text-gray-800 text-lg leading-relaxed mb-8 pr-8">
                      &quot;{testimonial.content}&quot;
                    </p>
                    ...
                    <div className="flex items-center">
                      <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mr-4">
                        <span className="text-[#ff5010] font-bold text-lg">
          ...
          <button 
            onClick={prevTestimonial}
            className="absolute top-1/2 -left-6 transform -translate-y-1/2 bg-white text-[#ff5010] p-3 rounded-full shadow-lg hover:bg-[#ff5010] hover:text-white transition-all duration-300 focus:outline-none z-20"
            aria-label="Previous testimonial"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          ...
          <button 
            onClick={nextTestimonial}
            className="absolute top-1/2 -right-6 transform -translate-y-1/2 bg-white text-[#ff5010] p-3 rounded-full shadow-lg hover:bg-[#ff5010] hover:text-white transition-all duration-300 focus:outline-none z-20"
            aria-label="Next testimonial"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
