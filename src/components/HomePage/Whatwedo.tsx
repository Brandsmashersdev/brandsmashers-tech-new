    ...
    <div className={styles.cardsContainer}>
      <div className={styles.cardsWrapper}>
        <div className={styles.sectionHeader}>
          ...
          <p>
            IT services that top the market offering a unique and excellent solution for businesses
            throughout all sectors. Being an experienced software development company, our solutions
            are designed to assist companies to be successful in present day marketplace.
          </p>
        </div>
            ...
            >
              <div className="bg-[#2CC5D9] w-full  h-[70px] overflow-hidden text-white flex justify-center items-center ">
                <div className="cir w-[120px] h-[125px]  rounded-full bottom-1 border-8 border-[#343333] bg-transparent justoify-center items-center flex mb-14">
                  {card.icon && (
                    <card.icon className="w-[60px] h-[60px] flex items-center justify-center text-[#343333] ml-5 pt-7" />
                  )}
                </div>
              </div>
